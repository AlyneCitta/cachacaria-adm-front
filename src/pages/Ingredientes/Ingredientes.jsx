...
const ProdutoList = () => {
  ...
  useEffect(() => {
    async function fetchProdutos() {
      try {
        const response = await api.get('/api/products/ingredientes');
  ...
  const handleEdit = (produtoId) => {
    navigate(`/ingredientes/edit/${produtoId}`);
  };
  ...
  return (
    <>
      ...
      <main>
        <BreadcrumbWrapper>
          <Breadcrumb>
            <span onClick={goToHome}>Principal</span> &gt; <span onClick={goToProdutos}>Ingredientes</span>
          </Breadcrumb>
        </BreadcrumbWrapper>
